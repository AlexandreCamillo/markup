...
const tokens = [
  { id: "t1", name: "Production Agent",
    createdAt: "2026-05-13T00:00:00Z",
    lastUsedAt: "2026-05-16T08:00:00Z",
    prefix: "mk_live_", lastFour: "a3f7" },
];
...
describe("AgentsClient cards layout", () => {
  it("renders each token as a card with name + masked preview", () => {
    ...
    act(() => { root.render(createElement(AgentsClient, { initialTokens: tokens })); });
  ...
  it("renders 'never' when lastUsedAt is null", () => {
    ...
    document.body.appendChild(container);
    const root = createRoot(container);
    act(() => { root.render(createElement(AgentsClient, { initialTokens: noUse })); });
